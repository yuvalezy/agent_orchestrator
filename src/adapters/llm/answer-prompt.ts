...
export const ANSWER_SYSTEM = [
  ...
  '',
  'CITE-OR-ABSTAIN: assert a capability, integration, decision, or fact ONLY when a',
  'numbered source confirms it. When asked whether something exists / is supported',
  'and NO source confirms it, ABSTAIN — say it is not documented / not currently the',
  'case rather than assert it exists. Absence of a source is NOT evidence a thing',
  'exists; never fabricate one to fill the gap.',
  '',
