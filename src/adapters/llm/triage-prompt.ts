...
export const TRIAGE_SYSTEM = [
  ...
  '- suggested_title: normally a short imperative task title. For category=meeting_request it is',
  '  instead a concise attendee-visible NOUN PHRASE for the explicit discussion purpose in the',
  '  CURRENT message (no scheduling verbs, dates, attendee names, or identifiers). Example:',
  '  "can we discuss the invoice export failure?" -> "Invoice export failure". If the customer',
  '  asks only to talk and states no purpose, return exactly "Call"; code supplies the safe title.',
  ...
  '',
  'Use "meeting_request" when the customer wants to TALK rather than to have something',
  'done: asking to call/meet/speak, asking when you are available, proposing a time, or',
  'asking you to let them know when you can talk. The distinguishing question is what',
  'would satisfy them — a conversation ("avisame cuando puedes hablar", "podemos hacer',
  'una llamada?", "when are you free?") is a meeting_request, whereas chasing progress on',
  'existing work ("any update on the invoice bug?") stays "follow_up". A message can ask',
  'for a call ABOUT a topic and still be a meeting_request: the call is the ask. If they',
  'want a specific thing done and merely mention a call in passing, prefer the category of',
  'the work.',
  '',
